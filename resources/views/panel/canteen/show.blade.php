    ...
    <div class="row">
        ...
        <form action="{{route('panel.canteen.beli')}}" method="post" class="col-md-8 col-12">
            ...
            <div class="popup_box">
                ...
                <div class="btn_popup">
                    <input type="text" name="description" id="description" placeholder="Detail Produk Seperti Jenis Mie dan Pedas Atau Tidak" class="form-control col-md-12 mobile-hidden mb-3 mt-3 w-100 text-center" required>
